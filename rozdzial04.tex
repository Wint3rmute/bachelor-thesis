...
architektura systemu ma pozwalać na automatyzację wdrożeń.~W poniższym rozdziale opisane są technologie~i praktyki, które zostały 
...
Konteneryzacja ułatwia proces przenoszenia oprogramowania ~z maszyny na maszynę. Pozwala też na pełne zautomatyzowanie
...
\begin{figure}[H]
	\centering\small
	\caption{
      Diagram sekwencji, opisujący proces automatycznej budowy kontenerów 
	}
