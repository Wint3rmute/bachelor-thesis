...
opisana została~w listingu \ref{list:ci_cd_frontend}. Diagram ilustrujący proces pracy
programisty~z systemem \textit{CI/CD} zawarty jest na rysunku \ref{ci_workflow}.
